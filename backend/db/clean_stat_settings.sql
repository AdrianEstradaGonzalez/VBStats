...
('Receptor', 'Recepción', 'Doble positivo', 1, NULL),
('Receptor', 'Recepción', 'Positivo', 1, NULL),
...
-- Opuesto
INSERT INTO stat_settings (position, stat_category, stat_type, enabled, user_id) VALUES
('Opuesto', 'Recepción', 'Doble positivo', 1, NULL),
('Opuesto', 'Recepción', 'Positivo', 1, NULL),
...
-- Colocador
INSERT INTO stat_settings (position, stat_category, stat_type, enabled, user_id) VALUES
('Colocador', 'Recepción', 'Doble positivo', 1, NULL),
('Colocador', 'Recepción', 'Positivo', 1, NULL),
...
-- Central
INSERT INTO stat_settings (position, stat_category, stat_type, enabled, user_id) VALUES
('Central', 'Recepción', 'Doble positivo', 1, NULL),
('Central', 'Recepción', 'Positivo', 1, NULL),
...
-- Líbero
INSERT INTO stat_settings (position, stat_category, stat_type, enabled, user_id) VALUES
('Líbero', 'Recepción', 'Doble positivo', 1, NULL),
('Líbero', 'Recepción', 'Positivo', 1, NULL),
